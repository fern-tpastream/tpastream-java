...
@JsonDeserialize(
    builder = AllMembers.Builder.class
)
public final class AllMembers implements IPageable {
  ...
  AllMembers(boolean hasNext, boolean hasPrev, Optional<Integer> nextNum, Optional<Integer> page,
      Optional<Integer> pages, Optional<Integer> perPage, Optional<Integer> prevNum,
      Optional<Integer> total, Member data) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AllMembers && equalTo((AllMembers) other);
  }

  private boolean equalTo(AllMembers other) {
  ...
  public String toString() {
    return "AllMembers{" + "hasNext: " + hasNext + ", hasPrev: " + hasPrev + ", nextNum: " + nextNum + ", page: " + page + ", pages: " + pages + ", perPage: " + perPage + ", prevNum: " + prevNum + ", total: " + total + ", data: " + data + "}";
  }
  ...
  static final class Builder implements HasNextStage, HasPrevStage, DataStage, _FinalStage {
    ...
    @Override
    public Builder from(AllMembers other) {
    ...
    @Override
    public AllMembers build() {
      return new AllMembers(hasNext, hasPrev, nextNum, page, pages, perPage, prevNum, total, data);
    }
  }
}
