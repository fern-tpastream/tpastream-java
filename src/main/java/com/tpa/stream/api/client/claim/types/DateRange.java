...
@JsonDeserialize(
    builder = DateRange.Builder.class
)
public final class DateRange {
  ...
  DateRange(Optional<String> bounds, Optional<String> end, Optional<String> start) {
    this.bounds = bounds;
    this.end = end;
    this.start = start;
  }
  ...
  public String toString() {
    return "DateRange{" + "bounds: " + bounds + ", end: " + end + ", start: " + start + "}";
  }
  ...
  public static final class Builder {
    ...
    public DateRange build() {
      return new DateRange(bounds, end, start);
    }
  }
}
