package com.tpa.stream.api.client.key.exceptions;
...
@JsonDeserialize(
    using = CreateGpgException.Deserializer.class
)
public final class CreateGpgException extends Exception {
  private final Value value;

  private int statusCode;

  private CreateGpgException(Value value, int statusCode) {
    this.value = value;
  ...
  public static CreateGpgException other(Object unknownValue, int statusCode) {
    return new CreateGpgException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "CreateGpgException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<CreateGpgException> {
    @Override
    public CreateGpgException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new CreateGpgException(value, statusCode);
    }
  }
}
